# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-29 22:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sentiment', models.FloatField(default=None, null=True)),
                ('pos', models.FloatField(default=None, null=True)),
                ('neu', models.FloatField(default=None, null=True)),
                ('neg', models.FloatField(default=None, null=True)),
                ('sentiment_string', models.CharField(default=None, max_length=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
